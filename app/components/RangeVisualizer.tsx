...
export default function RangeVisualizer({
  ...
  return (
    <div className="mt-6 mb-8 rounded-lg shadow-lg bg-gray-900 text-white border border-gray-700">
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-4 rounded-t-lg border-b border-gray-700 flex flex-wrap items-center">
        <div className="flex items-center flex-1">
          <div className="w-2 h-5 -ml-2 bg-gradient-to-r from-blue-700 to-blue-900 shadow-sm border border-blue-700 opacity-90"></div>
          <h3 className="font-bold text-lg sm:text-xl font-mono ml-2">
